...
def set_args():
    ...
    parser.add_argument('--rbt3', default=r'D:\硕士\培训\torch_pretrain_models\中文\rbt3', type=str,help='rbt3预训练模型路径')
    ...
    parser.add_argument('--num_classes', default=2, type=int, help='几分类任务')
